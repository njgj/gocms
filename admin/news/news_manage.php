  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="115" background="../images/tab_05.gif"><img src="../images/311.gif" width="16" height="16" /><span class="title">新闻管理</span></td>
      ...
      <tr>
        ...
        <td bgcolor="e5f1d6"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#D9F1BA">
          ...
          <tr bgcolor="#FFFFFF" onMouseMove="this.style.backgroundColor='#F6FEEB'" onMouseOut="this.style.backgroundColor='#FFFFFF'">
            ...
            <img src="../images/037.gif" width="9" height="9" />[<a href="javascript:;" onclick="newwin('news_add.php?id=<?php echo $row['id']?>',800,500);">编辑</a>]
            <img src="../images/010.gif" width="9" height="9" /> [<a href="javascript:void(0);" onClick="return confirm('删除《<?php echo $row['title'] ?>》，是否确定？')?newwin('?action=del&id=<?php echo $row['id']?>',1,1):false">删除</a>]

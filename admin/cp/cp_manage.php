    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td bgcolor="e5f1d6"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#D9F1BA">
          <tr>
            <td width="5%" height="26" align="center" background="../images/tab_14.gif" class="STYLE1">ID</td>
            <td width="34%" height="26" align="center" background="../images/tab_14.gif" class="STYLE1">产品名称</td>
            <td width="10%" height="26" align="center" background="../images/tab_14.gif" class="STYLE1">类别</td>
            <td width="11%" height="26" align="center" background="../images/tab_14.gif" class="STYLE1">厂家/品牌</td>
            <td width="12%" height="26" align="center" background="../images/tab_14.gif" class="STYLE1">时间</td>
            <td width="8%" align="center" background="../images/tab_14.gif" class="STYLE1">当前状态</td>
			...
			$sql.=($classid)?" and classid in (".getClassPath('g_nclass_cp',$classid).")":"";
				
			$total = $db->num_rows($db->query($sql));
			
			turnpage($total, $pagesize,"&key=$key&classid=$classid");

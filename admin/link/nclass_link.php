...
<thead>
  ...
  <?php
	...
	case 'act_add':
		...
		$sql = "INSERT INTO g_nclass_link (classname,parentid,orderid) VALUES('".$_POST['classname']."',".$_POST['parentid'].",".$_POST['orderid'].")";
		$db -> query($sql);
...
function delclass($classid){
    ...
    if($classid){
		...
		$db->query("delete from g_nclass_link where classid in ($classpath)");
